...
//namespace BookingHotelsAPI.Application.Services
//{
//    public class CountriesServiceMemoryCashe(HotelBookingDbContext context, IMapper mapper, IMemoryCache cache) : ICountriesService
//    {
...
//        private void InvalidateCountryCache(int id) // для работы с кеш
//        {
